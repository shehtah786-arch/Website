...
export default function ExamPage() {
  ...
  const questions = [
    ...
    {
      id: 6,
      q: "أيا مما يلي يعد احدي المشكلات الزراعه في وطننا العربي...؟",
      options: ["توشكى", "تذبذب كمية المطر ", "انتشار الأسواق", "تنوع المناخ"],
      ans: 1  
    },
    {
      id: 7,
      q: "دوله تقوم فيها الزراعة علي مياه الانهار...؟",
      options: ["السعودية", " السوادان ", "قطر ", " ليبيا"],
      ans: 1  
    },
    {
      id: 8,
      q: "محصول يصنف من محاصيل الحبوب الغذائيه...؟",
      options: ["قصب السكر", " العنب ", "القمح ", " الكتان"],
      ans: 2  
    },
    {
      id: 9,
      q: "احد المقومات الطبيعيه للزراعه...؟",
      options: [" النقل", " راس المال ", " الأيدي العاملة المدربة", " التربه الخصبه"],
      ans: 3  
    },
    {
      id: 10,
      q: "يزرع الوطن العربي المحاصيل السكريه ومنها...؟",
      options: [" القمح", " الزيتون  ", "   القصب", " القطن "],
      ans: 3  
    }
  ];
