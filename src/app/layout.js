...
export default function RootLayout({ children }) {
  return (
    <html lang="ar" dir="rtl">
      <body>
        {/* شريط التنقل (Navbar) باللون الأخضر الفاتح */}
        <nav className="bg-green-100 shadow-sm p-4 sticky top-0 z-50 border-b border-green-200">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div className="flex gap-6">
              ...
              {/* تعديل الرابط هنا ليوجه لصفحة الاختيارات */}
              <Link href="/objectives" className="font-bold text-green-800 hover:text-green-600 transition-colors">المحتوى</Link>
