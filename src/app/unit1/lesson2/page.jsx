...
export default function Lesson2() {
  return (
    <div className="min-h-screen bg-[#faf9f6] flex flex-col items-center p-6" dir="rtl">
      ...
      {/* حاوية مركزية لضمان توازي جميع العناصر عمودياً */}
      <div className="w-full max-w-5xl">
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* كارت المشكلات */}
            <div className="bg-red-50 p-8 rounded-3xl border-r-8 border-red-500 shadow-sm transition hover:shadow-md h-full">
            ...
            {/* كارت جهود الدول */}
            <div className="bg-green-50 p-8 rounded-3xl border-r-8 border-green-600 shadow-sm transition hover:shadow-md h-full">
        ...
        <section className="mb-20">
          ...
          <div className="bg-white rounded-[2rem] overflow-hidden shadow-xl border border-gray-100 group">
            ...
            <div className="p-8 text-center bg-blue-50/30">
              <h3 className="text-2xl font-black text-blue-900 mb-3">الزراعة في وطننا العربي «شرح كرتون»</h3>
